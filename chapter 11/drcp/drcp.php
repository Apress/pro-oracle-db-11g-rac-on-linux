...
<html>
  ...
  <title>DRCP Connection Page</title>
</head>
<body>
...
<?php
  if ( $conn=OCILogon("username", "password", "drcp")) {
    echo "Successfully connected to Oracle using DRCP.\n";
    ...
    $err = OCIError();
    echo "Error connecting to the Oracle." . $err["message"];
  }
?>
